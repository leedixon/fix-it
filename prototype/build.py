...
# /.well-known/acme-challenge/. Never redirect or rewrite that path: if the
# certificate ever lapses, redirecting renewal traffic to a broken HTTPS host
# is how a site gets permanently stuck with an expired certificate.
